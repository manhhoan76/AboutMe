                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                              ...
                              <tr>
								 <td>${objCat.id_cat }</td>
                                 <td>${objCat.name }</td>
                                 <td>${objCat.date_create }</td>
                                 <td>
                                  <div class="btn-group">
                                  <ul class="nav nav-tabs">
                                  	<li><a class="btn btn-primary" href="${pageContext.request.contextPath }/admin/cat/edit/${objCat.id_cat }"><i class="icon_pencil-edit_alt"></i></a></li>
                                	<li><a class="btn btn-danger" onclick="return confirm('Bạn có muốn xóa không')" href="${pageContext.request.contextPath }/admin/cat/del/${objCat.id_cat}"><i class="icon_close_alt2"></i></a></li>
                                  </ul>
                                  </div>
                                  </td>
                              </tr>
