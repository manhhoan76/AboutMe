		  ...
		  <div class="row">
				<div class="col-lg-12">
					...
					<ol class="breadcrumb">
						...
						<li><i class="fa fa-table"></i><a href="${pageContext.request.contextPath }/admin/user/add">Add</a></li>
					</ol>
				</div>
			</div>
			<c:choose>
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath }/admin/user/add">
                                  ...
                                  <div class="form-group">
                                      <label class="control-label col-lg-2" for="inputSuccess">Active</label>
                                      <div class="col-lg-10">
                                          <select id="active"  class="form-control round-input" name="enable" >
